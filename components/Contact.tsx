    ...
    <div className="bg-white pb-20">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
            ...
            <form className="space-y-6" onSubmit={handleSubmit} noValidate>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    } rounded-2xl px-5 py-4 outline-none focus:ring-4 ring-red-500/5 font-bold transition-all`}
                  />
                  {errors.firstName && (
                    <p className="text-[9px] text-red-500 font-bold mt-1 ml-2 uppercase tracking-tighter">
                      {errors.firstName}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 animate-fade-up">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="e.g. 4"
                      className={`w-full bg-white border ${
                        errors.members ? "border-red-500" : "border-gray-100"
                      } rounded-2xl px-5 py-4 outline-none focus:ring-4 ring-red-500/5 font-bold transition-all`}
                    />
                    {errors.members && (
                      <p className="text-[9px] text-red-500 font-bold mt-1 ml-2 uppercase tracking-tighter">
                  ...
                  <div>
                    ...
                    >
                      <input
                        ...
                        className={`w-full bg-white border ${
                          errors.dateTime ? "border-red-500" : "border-gray-100"
                        } rounded-2xl px-5 py-4 pl-12 outline-none focus:ring-4 ring-red-500/5 font-bold transition-all cursor-pointer block text-sm`}
                      />
              ...
              <div>
                ...
                <textarea
                  ...
                  } rounded-2xl px-5 py-4 outline-none focus:ring-4 ring-red-500/5 font-bold transition-all resize-none`}
                ></textarea>
                {errors.message && (
                  <p className="text-[9px] text-red-500 font-bold mt-1 ml-2 uppercase tracking-tighter">
                    {errors.message}
        ...
        <div className="animate-fade-up">
          ...
          <div
            className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 max-w-5xl mx-auto gap-10`}
          >
            {outlets.map((o, idx) => (
              <div
                key={o.id}
              ...
              >
                ...
                <div className="p-10 flex flex-col flex-grow">
                  <h3 className="text-2xl font-playfair font-bold mb-4 group-hover:text-[#C0392B] transition-colors text-gray-900">
                    {o.name}
                  </h3>
                  ...
                  {o.directionsLink ? (
                    <a
                      href={o.directionsLink}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-full py-4 border-2 border-gray-100 text-gray-400 rounded-2xl font-black uppercase tracking-widest text-[9px] hover:border-[#C0392B] hover:text-[#C0392B] transition-all flex items-center justify-center gap-2"
                    >
                      Get Directions
                      <svg
                        className="w-3 h-3"
                    ...
                    <button
                      disabled
                      className="w-full py-4 border-2 border-gray-200 text-gray-300 rounded-2xl font-black uppercase tracking-widest text-[9px] flex items-center justify-center gap-2 cursor-not-allowed"
                    >
                      Get Directions
                      <svg
                        className="w-3 h-3"
