  ...
  return (
    <section className="relative h-screen w-full flex flex-col items-center justify-center overflow-hidden bg-black">
      ...
      <div className="relative z-10 w-full max-w-5xl px-6 flex flex-col items-center text-center">
        ...
        {/* Hero Headline */}
        <h1 className="animate-fade-up text-7xl md:text-[10rem] lg:text-[12rem] font-playfair leading-[0.85] text-white drop-shadow-2xl">
          Meals <span className="italic">&</span><br />
          <span className="text-[#C0392B]">Memories.</span>
        </h1>

        {/* Secondary Tagline */}
        <div className="mt-8 md:mt-12 space-y-4 animate-fade-up" style={{ animationDelay: '300ms' }}>
        ...
        {/* Centered CTA */}
        <div className="mt-12 md:mt-16 animate-fade-up" style={{ animationDelay: '500ms' }}>
          <button 
            onClick={() => onSelectOutlet(outlets[0])}
            className="group relative bg-[#C0392B] text-white px-12 md:px-20 py-5 rounded-full font-black uppercase tracking-[0.4em] text-[11px] shadow-[0_20px_50px_rgba(192,57,43,0.3)] hover:bg-white hover:text-black transition-all duration-500 active:scale-95 border-2 border-white/10"
          >
            ORDER NOW
          </button>
        </div>
      ...
      <div className="absolute left-10 top-1/2 -translate-y-1/2 -rotate-90 origin-left hidden xl:block opacity-20 pointer-events-none">
        <p className="text-white font-black uppercase tracking-[1em] text-[10px]">THE CULINARY SANCTUARY</p>
      </div>
      <div className="absolute right-10 top-1/2 -translate-y-1/2 rotate-90 origin-right hidden xl:block opacity-20 pointer-events-none">
        <p className="text-white font-black uppercase tracking-[1em] text-[10px]">AUTHENTIC SINCE 1984</p>
      </div>
